...
class MainContainer extends React.Component {
  ...
  onChangeField = (e) => {
    let plan = Object.assign({}, this.state)
      ...
      <div id="content">
        <div id="main_container">
          <form action="javascript:void(0)" id="plans_form">
            <LocationField { ...this.props } onChangeField={ this.onChangeField } { ...this.state }/>
...
const LocationField = props => (
  <div id="place_field">
    <label>どちらまで</label>
    { console.log(props) }
    <input placeholder="北海道旭川市" name="location" value={ props.location } onChange={ props.onChangeField } />
  </div>
)
...
const DescriptionField = props => (
  <div id="description_field">
    ...
    <textarea rows="5" placeholder="美味しいものをたくさん食べたい！" name="description" onChange={ props.onChangeField } />
  </div>
)
